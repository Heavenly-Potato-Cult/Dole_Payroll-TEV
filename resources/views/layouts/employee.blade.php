    ...
    <nav class="employee-nav">
        <div class="employee-nav-inner">
            ...
            <div class="employee-nav-links">
                <a href="{{ route('my-payslip') }}" class="employee-nav-link {{ request()->routeIs('my-payslip') ? 'active' : '' }}">
                    My Payslip
                </a>
                <a href="{{ route('tev.requests.index') }}" class="employee-nav-link {{ request()->routeIs('tev.requests.*') ? 'active' : '' }}">
                    TEV Requests
                </a>
            </div>
