...
use Modules\Allowances\Models\AllowanceBatch;
use Modules\Allowances\Models\AllowanceEntry;
...
class AllowanceBatchController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('allowances::batches.index', compact('batches', 'currentYear'));
    }
    ...
    public function create()
    {
        ...
        return view('allowances::batches.create', compact('types', 'employees'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('allowances.batches.show', $batch)
    ...
    public function show(AllowanceBatch $batch)
    {
        ...
        return view('allowances::batches.show', compact('batch'));
    }
    ...
    public function edit(AllowanceBatch $batch)
    {
        ...
        return view('allowances::batches.edit', compact('batch', 'types', 'employees'));
    }
