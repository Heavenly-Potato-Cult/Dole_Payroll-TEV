...
<div class="page-header">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;">
        <a href="{{ route('allowances.types.index') }}" class="btn btn-outline">Allowance Types</a>
        <a href="{{ route('allowances.batches.create') }}" class="btn btn-primary">+ New Batch</a>
    </div>
</div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('allowances.batches.show', $batch) }}" class="btn btn-sm btn-outline">View</a></td>
                </tr>
                @empty
