...
class HdmfP1Export implements FromCollection, WithTitle, WithEvents
{
    ...
    private function compute(): void
    {
        ...
        foreach ($entries as $entry) {
            ...
            $this->rows[] = [
                $emp->pagibig_mid_no ?? $emp->pagibig_no ?? '',   // col A - Pag-IBIG MID NO.
                '',                            // col B - MP2 ACCOUNT NO. (blank for P1)
                // col C - MEMBERSHIP PROGRAM filled directly in buildSheet
                $emp->last_name      ?? '',   // col D
    ...
    public function title(): string { return 'HDMF P1'; }
    ...
    private function buildSheet(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $ws): void
    {
        ...
        // Row 4 intentionally blank (matches DOLE template)
        ...
        foreach (['A' => 18.71, 'B' => 16.71, 'C' => 15.71, 'D' => 19.71, 'E' => 20.71,
                  'F' => 11.71, 'G' => 15.71, 'H' => 10.71, 'I' => 12.71, 'J' => 9.71,
                  'K' => 13.71] as $col => $w) {
