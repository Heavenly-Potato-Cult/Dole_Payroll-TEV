            ...
            <form method="POST" action="{{ route('special-payroll.differential.store') }}" id="diffForm">
                ...
                <div class="form-group" style="margin-top:16px;">
                    ...
                    <input type="number" id="pera_adjustment" name="pera_adjustment"
                           ...
                           step="0.01" min="0"
                           placeholder="Leave blank if this differential does not include a PERA change"
                           class="{{ $errors->has('pera_adjustment') ? 'is-invalid' : '' }}"
                           oninput="updatePreview()">
                    <div style="font-size:0.75rem; color:var(--text-light); margin-top:4px;">
                        Only fill this in if the employee's PERA also changed as part of this adjustment
                        (e.g. a status change alongside the salary change). Entered as a single flat
    ...
    <div style="display:flex; flex-direction:column; gap:16px;">
        ...
        <div class="card">
            ...
            <div class="card-body" style="font-size:0.78rem; color:var(--text-mid); line-height:1.7;">
                ...
                <strong>Net</strong> = Gross Amount − All Deductions
            </div>
        </div>
