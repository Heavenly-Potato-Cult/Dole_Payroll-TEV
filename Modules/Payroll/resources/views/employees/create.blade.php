            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="hdmf_housing_app_no" name="hdmf_housing_app_no"
                           value="{{ old('hdmf_housing_app_no') }}" maxlength="80">
                </div>
                <div class="form-group">
