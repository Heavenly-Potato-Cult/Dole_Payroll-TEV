<?php $__env->startSection('title', 'TEV Requests'); ?>
<?php $__env->startSection('page-title', 'Travel (TEV)'); ?>
...
<div class="card">
    <div class="card-body" style="padding:0;">
        <div class="tev-tabs">
            <button class="tev-tab <?php echo e($activeTab === 'process' ? 'active' : ''); ?>" onclick="switchTab('process')">
                🔄 In Process (<?php echo e($inProcessRequests->total()); ?>)
            </button>
            <button class="tev-tab <?php echo e($activeTab === 'liquidated' ? 'active' : ''); ?>" onclick="switchTab('liquidated')">
                ✅ Liquidated (<?php echo e($liquidatedRequests->total()); ?>)
            </button>
        </div>
        
        
        <div id="process-tab" class="tev-tab-content <?php echo e($activeTab === 'process' ? 'active' : ''); ?>">
            <div style="padding:20px;">
                        ...
                        <form method="GET" action="<?php echo e(route('tev.requests.index')); ?>" class="filter-form">
                            ...
                            <div class="ff-group" style="min-width:150px;">
                                ...
                                <select name="process_track" id="process_track">
                                    ...
                                    <option value="cash_advance"  <?php echo e(request('process_track') === 'cash_advance'  ? 'selected' : ''); ?>>Cash Advance</option>
                                    <option value="reimbursement" <?php echo e(request('process_track') === 'reimbursement' ? 'selected' : ''); ?>>Reimbursement</option>
                                </select>
                            </div>
                            ...
                            <div class="ff-group" style="min-width:180px;">
                                ...
                                <select name="process_status" id="process_status">
                                    ...
                                    <option value="submitted" <?php echo e(request('process_status') === 'submitted' ? 'selected' : ''); ?>>Submitted</option>
                                    <option value="accountant_certified" <?php echo e(request('process_status') === 'accountant_certified' ? 'selected' : ''); ?>>Accountant Certified</option>
                                    <option value="rd_approved" <?php echo e(request('process_status') === 'rd_approved' ? 'selected' : ''); ?>>RD Approved</option>
                                    <option value="cashier_released" <?php echo e(request('process_status') === 'cashier_released' ? 'selected' : ''); ?>>Cashier Released</option>
                                    <option value="liquidation_filed" <?php echo e(request('process_status') === 'liquidation_filed' ? 'selected' : ''); ?>>Liquidation Filed</option>
                                    <option value="rejected" <?php echo e(request('process_status') === 'rejected' ? 'selected' : ''); ?>>Rejected</option>
                                </select>
                            </div>
                ...
                <?php echo $__env->make('tev::partials.tev-table', ['tevRequests' => $inProcessRequests, 'pageName' => 'process_page'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
        
        
        <div id="liquidated-tab" class="tev-tab-content <?php echo e($activeTab === 'liquidated' ? 'active' : ''); ?>">
            <div style="padding:20px;">
                        ...
                        <form method="GET" action="<?php echo e(route('tev.requests.index')); ?>" class="filter-form">
                            ...
                            <div class="ff-group" style="min-width:150px;">
                                ...
                                <select name="track" id="track">
                                    <option value="">All Tracks</option>
                                    <option value="cash_advance"  <?php echo e(request('track') === 'cash_advance'  ? 'selected' : ''); ?>>Cash Advance</option>
                                    <option value="reimbursement" <?php echo e(request('track') === 'reimbursement' ? 'selected' : ''); ?>>Reimbursement</option>
                                </select>
                            </div>
                ...
                <?php echo $__env->make('tev::partials.tev-table', ['tevRequests' => $liquidatedRequests, 'pageName' => 'liquidated_page'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.tev', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Training_Ground\Visual Studio Code\DOLESYSTEM2\Dole_Payroll\Modules/Tev\resources/views/index.blade.php ENDPATH**/ ?>