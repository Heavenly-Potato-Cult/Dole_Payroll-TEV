<?php $__env->startSection('title', 'My TEV Requests'); ?>
<?php $__env->startSection('page-title', 'My TEV Requests'); ?>
...
<div class="page-header">
    ...
    <a href="<?php echo e(route('tev.requests.create')); ?>" class="btn btn-primary">+ New TEV</a>
</div>
    ...
    <div style="padding: 20px;">
        <div class="tev-tabs">
            <button class="tev-tab-btn active"
                ...
                In Process
                <span class="tev-tab-badge tev-tab-badge-process"><?php echo e($inProcessRequests->total()); ?></span>
            </button>
            <button class="tev-tab-btn"
                ...
                Liquidated
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($liquidatedRequests->count() > 0): ?>
                    <span class="tev-tab-badge tev-tab-badge-liquidated"><?php echo e($liquidatedRequests->total()); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </button>
        </div>
    </div>
...
<div class="tev-tab-panel active" id="tab-panel-process">
    ...
    <div class="card" style="margin-bottom: 24px;">
        <div style="padding: 20px;">
            <form method="GET" action="<?php echo e(route('tev.requests.index')); ?>" class="filter-form">
                ...
                <div class="ff-group" style="min-width:180px;">
                    ...
                    <select name="track" id="track_process">
                        ...
                        <option value="cash_advance"  <?php echo e(request('track') === 'cash_advance'  && request('tab','process') === 'process' ? 'selected' : ''); ?>>Cash Advance</option>
                        <option value="reimbursement" <?php echo e(request('track') === 'reimbursement' && request('tab','process') === 'process' ? 'selected' : ''); ?>>Reimbursement</option>
                    </select>
                </div>

                <div class="ff-btns">
                    <button type="submit" class="btn btn-primary btn-sm">Filter</button>
                    <a href="<?php echo e(route('tev.requests.index')); ?>?tab=process" class="btn btn-outline btn-sm">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom: 48px;">
        <div class="table-wrap">
            <table class="sd-table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $inProcessRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $emp = $tev->employee;
                        ...
                        <tr class="sd-main-row" data-id="<?php echo e($tev->id); ?>" onclick="toggleSdRow(this)">
                            ...
                            <td class="col-destination">
                                <span class="sd-name-label"><?php echo e($tev->destination); ?></span>
                                <span class="sd-name-sub">TEV Request</span>
                            </td>
                            <td class="col-track">
                                <span style="font-size:0.72rem; font-weight:700; padding:3px 8px; border-radius:12px; <?php echo e($trackStyle); ?>">
                                    <?php echo e($trackLabel); ?>

                                </span>
                            </td>
                            <td class="col-dates text-muted" style="font-size:0.82rem; white-space:nowrap;">
                                <?php echo e($tev->travel_date_start->format('M d')); ?> – <?php echo e($tev->travel_date_end->format('M d, Y')); ?>
                            ...
                            <td colspan="7">
                                <div class="sd-detail-grid">
                                    ...
                                    <div class="sd-detail-item">
                                        ...
                                        <span><?php echo e($tev->destination); ?></span>
                                    </div>
                                    <div class="sd-detail-item">
                                        <label>Track</label>
                                        <span>
                                            <span style="font-size:0.72rem; font-weight:700; padding:2px 8px; border-radius:10px; <?php echo e($trackStyle); ?>"><?php echo e($trackLabel); ?></span>
                                        </span>
                                    </div>
                                    <div class="sd-detail-item">
                                        <label>Grand Total</label>
                                        <span class="mono" style="color:var(--navy); font-weight:700;">₱<?php echo e(number_format($tev->grand_total, 2)); ?></span>
                                    </div>
                                    <div class="sd-detail-item">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inProcessRequests->hasPages()): ?>
        <div style="padding: 16px 20px;">
            <?php echo e($inProcessRequests->appends(['tab' => 'process', 'track' => request('track')])->links()); ?>
...
<div class="tev-tab-panel" id="tab-panel-liquidated">
            ...
            <form method="GET" action="<?php echo e(route('tev.requests.index')); ?>" class="filter-form">
                ...
                <div class="ff-group" style="min-width:180px;">
                    ...
                    <select name="track" id="track_liquidated">
                        <option value="">All Tracks</option>
                        <option value="cash_advance"  <?php echo e(request('track') === 'cash_advance'  && request('tab') === 'liquidated' ? 'selected' : ''); ?>>Cash Advance</option>
                        <option value="reimbursement" <?php echo e(request('track') === 'reimbursement' && request('tab') === 'liquidated' ? 'selected' : ''); ?>>Reimbursement</option>
                    </select>
                </div>

                <div class="ff-btns">
                    <button type="submit" class="btn btn-primary btn-sm">Filter</button>
                    <a href="<?php echo e(route('tev.requests.index')); ?>?tab=liquidated" class="btn btn-outline btn-sm">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom: 48px;">
        <div class="table-wrap">
            <table class="sd-table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $liquidatedRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $emp = $tev->employee;
                            $trackLabel = $tev->track === 'cash_advance' ? 'Cash Advance' : 'Reimbursement';
                            $trackStyle = $tev->track === 'cash_advance'
                        ...
                        <tr class="sd-main-row" data-id="liq-<?php echo e($tev->id); ?>" onclick="toggleSdRow(this)">
                            <td class="col-tev fw-bold" style="color:var(--navy); white-space:nowrap;">
                                <?php echo e($tev->tev_no); ?>
                        ...
                        <tr class="sd-detail-row" id="sd-detail-liq-<?php echo e($tev->id); ?>">
                            <td colspan="7">
                                <div class="sd-detail-grid">
                                    <div class="sd-detail-item">
                                        <label>TEV No.</label>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($liquidatedRequests->hasPages()): ?>
        <div style="padding: 16px 20px;">
            <?php echo e($liquidatedRequests->appends(['tab' => 'liquidated', 'track' => request('track')])->links()); ?>
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Training_Ground\Visual Studio Code\DOLESYSTEM2\Dole_Payroll\Modules/Tev\resources/views/employee-requests.blade.php ENDPATH**/ ?>