    ...
    <nav class="top-nav">
        <div class="top-nav-inner">
            ...
            <div class="top-nav-links">
                <a href="<?php echo e(route('my-payslip')); ?>" class="top-nav-link <?php echo e(request()->routeIs('my-payslip') ? 'active' : ''); ?>">
                    My Payslip
                </a>
                <a href="<?php echo e(route('tev.requests.index')); ?>" class="top-nav-link <?php echo e(request()->routeIs('tev.requests.*') ? 'active' : ''); ?>">
                    TEV Requests
                </a>
            </div>
...
<?php /**PATH C:\Training_Ground\Visual Studio Code\DOLESYSTEM2\Dole_Payroll\resources\views/layouts/top-nav.blade.php ENDPATH**/ ?>