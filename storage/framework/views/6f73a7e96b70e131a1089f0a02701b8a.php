<?php $__env->startSection('title', 'Regular Payroll'); ?>
<?php $__env->startSection('page-title', 'Regular Payroll'); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('canCreatePayroll')): ?>
...
<div class="card mb-3">
    <div class="card-body" style="padding:14px 20px;">
        <form method="GET" action="<?php echo e(route('payroll.index')); ?>" class="filter-form">
            ...
            <div class="ff-group" style="min-width:140px;">
                ...
                <select name="month" id="month">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['January','February','March','April','May','June',
                        ...
                        <option value="<?php echo e($i + 1); ?>" <?php echo e(request('month') == $i + 1 ? 'selected' : ''); ?>>
                            <?php echo e($m); ?>
            ...
            <div class="ff-group" style="min-width:180px;">
                ...
                <select name="status" id="status">
                    ...
                    <option value="computed"            <?php echo e(request('status') === 'computed'            ? 'selected' : ''); ?>>Computed</option>
                    <option value="pending_accountant"  <?php echo e(request('status') === 'pending_accountant'  ? 'selected' : ''); ?>>Pending Accountant</option>
                    <option value="pending_rd"          <?php echo e(request('status') === 'pending_rd'          ? 'selected' : ''); ?>>Pending RD/ARD</option>
            ...
            <div class="ff-btns">
                ...
                <a href="<?php echo e(route('payroll.index')); ?>" class="btn btn-outline btn-sm">Reset</a>
            </div>
...
<div class="pr-tabs">
    <button class="pr-tab-btn active" data-tab="active" onclick="switchTab('active')">
        Active Batches (<?php echo e($activeBatches->count()); ?>)
    </button>
    <button class="pr-tab-btn" data-tab="locked" onclick="switchTab('locked')">
        Locked Batches (<?php echo e($lockedBatches->count()); ?>)
    </button>
</div>
        ...
        <div class="card-body" style="padding:0;">
            <div class="table-wrap">
                <table class="pr-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $activeBatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $months = [
                        ...
                        <tr class="pr-main-row" data-id="<?php echo e($batch->id); ?>" onclick="togglePrRow(this)">
                            <td class="col-period">
                                <span class="pr-period-label"><?php echo e($periodLabel); ?></span>
                                <span class="pr-period-sub">Monthly · <?php echo e($batch->period_year); ?></span>
                            </td>
                            
                            <td class="col-status">
                                <span class="badge <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></span>
                            </td>
                            <td class="col-employees text-right"><?php echo e($entryCount); ?></td>
                            <td class="col-gross text-right">
                                <?php echo e($entryCount > 0 ? '₱' . number_format($totalGross, 2) : '—'); ?>

                            </td>
                            <td class="col-deductions text-right">
                                <?php echo e($entryCount > 0 ? '₱' . number_format($totalDeds, 2) : '—'); ?>

                            </td>
                            <td class="col-netpay text-right fw-bold">
                                <?php echo e($entryCount > 0 ? '₱' . number_format($totalNet, 2) : '—'); ?>

                            </td>
                            <td class="col-remarks text-muted" style="font-size:0.80rem; max-width:260px;">
                                <?php echo e($batch->remarks ?: '—'); ?>

                            </td>
                            <td class="col-creator text-muted" style="font-size:0.82rem;">
                                <?php echo e($batch->creator->name ?? '—'); ?><br>
                                <span style="font-size:0.75rem;">
                                    <?php echo e($batch->created_at->format('M d, Y')); ?>

                                </span>
                            </td>
                            <td class="col-actions">
                                <div class="d-flex gap-2 flex-wrap">
                                    <a href="<?php echo e(route('payroll.show', $batch)); ?>"
                                       class="btn btn-outline btn-sm"
                                       onclick="event.stopPropagation();">View</a>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('role', 'payroll_officer|super_admin')): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($batch->status === 'draft'): ?>
                                            <form id="deleteForm-<?php echo e($batch->id); ?>" method="POST"
                                                  action="<?php echo e(route('payroll.destroy', $batch)); ?>">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="button" class="btn btn-danger btn-sm"
                                                        onclick="event.stopPropagation(); confirmDeletePayroll(<?php echo e($batch->id); ?>, '<?php echo e($batch->period_year); ?>-<?php echo e(str_pad($batch->period_month, 2, '0', STR_PAD_LEFT)); ?>')">Delete</button>
                                            </form>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                        ...
                        <tr class="pr-detail-row" id="pr-detail-<?php echo e($batch->id); ?>">
                            <td colspan="10">
                                <div class="pr-detail-grid">
                                    <div class="pr-detail-item">
                                        <label>Employees</label>
                                        <span><?php echo e($entryCount); ?></span>
                                    </div>
                                    <div class="pr-detail-item">
                                        <label>Total Gross</label>
                                        <span class="mono"><?php echo e($entryCount > 0 ? '₱' . number_format($totalGross, 2) : '—'); ?></span>
                                    </div>
                                    <div class="pr-detail-item">
                                        <label>Total Deductions</label>
                                        <span class="mono"><?php echo e($entryCount > 0 ? '₱' . number_format($totalDeds, 2) : '—'); ?></span>
                                    </div>
                                    <div class="pr-detail-item">
                                        <label>Total Net Pay</label>
                                        <span class="mono" style="font-weight:700;"><?php echo e($entryCount > 0 ? '₱' . number_format($totalNet, 2) : '—'); ?></span>
                                    </div>
                                    <div class="pr-detail-item">
                                        <label>Created By</label>
                                        <span><?php echo e($batch->creator->name ?? '—'); ?><br>
                                            <small style="color:var(--text-light);"><?php echo e($batch->created_at->format('M d, Y')); ?></small>
                                        </span>
                                    </div>
                                    <div class="pr-detail-item" style="grid-column: 1 / -1;">
                                        <label>Remarks</label>
                                        <span><?php echo e($batch->remarks ?: '—'); ?></span>
                                    </div>
                                </div>
                                <div class="pr-detail-actions">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('canCreatePayroll')): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($batch->status === 'draft'): ?>
                                            <button type="button" class="btn btn-danger btn-sm" style="width:100%;" onclick="confirmDeletePayroll(<?php echo e($batch->id); ?>, '<?php echo e($batch->period_year); ?>-<?php echo e(str_pad($batch->period_month, 2, '0', STR_PAD_LEFT)); ?>')">Delete</button>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </td>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <tr>
                            <td colspan="9" style="text-align:center; padding:40px; color:var(--text-light);">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('canCreatePayroll')): ?>
                                    <a href="<?php echo e(route('payroll.create')); ?>">Create one now →</a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                        </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="card-body" style="padding:0;">
            <div class="table-wrap">
                <table class="pr-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $lockedBatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $months = [
                                '', 'January', 'February', 'March', 'April', 'May', 'June',
                                'July', 'August', 'September', 'October', 'November', 'December',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Training_Ground\Visual Studio Code\DOLESYSTEM2\Dole_Payroll\Modules/Payroll\resources/views/payroll/index.blade.php ENDPATH**/ ?>