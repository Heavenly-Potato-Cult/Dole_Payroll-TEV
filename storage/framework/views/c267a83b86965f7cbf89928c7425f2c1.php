<?php $__env->startSection('title', 'Payroll Batch Detail'); ?>
<?php $__env->startSection('page-title', 'Payroll Batch'); ?>
...
<div class="card header-card">
    <div class="card-body" style="padding: 20px 20px 0 20px; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
        ...
        <div class="page-header" style="margin-bottom: 24px;">
            <div class="page-header-left">
                <h1><?php echo e($periodLabel); ?></h1>
                <p>
                    Monthly payroll ·
                    <span class="badge <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></span>
                    · Created by <?php echo e($payroll->creator->name ?? '—'); ?>

                    on <?php echo e($payroll->created_at->format('M d, Y')); ?>

                </p>
            </div>
            <div class="d-flex gap-2 flex-wrap payroll-show-actions">
                <a href="<?php echo e(route('payroll.index')); ?>" class="btn btn-outline btn-sm">← All Batches</a>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canPullAttendance): ?>
        
        <form method="POST" action="<?php echo e(route('payroll.pullAttendance', $payroll)); ?>" id="pullAttendanceForm">
            <?php echo csrf_field(); ?>
            <button type="button" class="btn btn-outline btn-sm" onclick="confirmPullAttendance()">
                <?php echo e($snapshotCount > 0 ? '🔄 Re-pull Attendance' : '📥 Pull Attendance'); ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($snapshotCount > 0): ?>
                    <span style="font-size:0.72rem; opacity:0.8;">(<?php echo e($snapshotCount); ?>/<?php echo e($activeCount); ?>)</span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </button>
        </form>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canCompute): ?>
        <form method="POST" action="<?php echo e(route('payroll.compute', $payroll)); ?>" id="computeForm">
            <?php echo csrf_field(); ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($snapshotCount === 0): ?>
                <button type="button" class="btn btn-gold btn-sm" disabled title="Pull attendance first">
                    ⚙ <?php echo e($payroll->status === 'draft' ? 'Compute Payroll' : 'Re-compute'); ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextAction): ?>
                <form method="POST" action="<?php echo e($nextAction['route']); ?>" id="nextActionForm">
                    <?php echo csrf_field(); ?>
                    <button type="button" class="btn <?php echo e($nextAction['class']); ?> btn-sm" onclick="confirmNextAction()">
                        ✔ <?php echo e($nextAction['label']); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($payroll->status, ['released', 'locked'])): ?>
        <button class="btn btn-outline btn-sm" onclick="openPayslipModal()">
            🧾 Generate Payslips
        </button>
    <?php elseif($isComputed): ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payroll->status === 'released' || auth()->user()->hasRole('cashier')): ?>
                <a href="<?php echo e(route('payroll.verify', $payroll)); ?>" class="btn btn-outline btn-sm">
                    📋 Verify Net Pay
                </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <?php echo $__env->make('payroll::payroll._approval_bar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</div>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payroll->remarks): ?>
    <div class="alert" style="background:#FAFBFF; border-color:var(--border); margin-top:14px;">
        <strong style="color:var(--navy);">Remarks:</strong> <?php echo e($payroll->remarks); ?>
...
<div style="padding: 20px 24px; margin-top: 20px;">
    <div class="stat-grid">
        ...
        <div class="stat-card gold">
            ...
            <div class="stat-value">₱<?php echo e(number_format($totalGross, 2)); ?></div>
            <div class="stat-sub">Basic + all allowances</div>
        </div>
        <div class="stat-card red">
            <div class="stat-label">Total Deductions</div>
            <div class="stat-value">₱<?php echo e(number_format($totalDeds, 2)); ?></div>
            <div class="stat-sub">All deduction lines</div>
        </div>
        <div class="stat-card green">
            <div class="stat-label">Total Net Pay</div>
            <div class="stat-value">₱<?php echo e(number_format($totalNet, 2)); ?></div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($payroll->status, ['draft', 'computed'])): ?>
<div class="card" style="margin-bottom:20px;">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3>📋 Attendance Data</h3>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($snapshotCount > 0): ?>
            <span class="badge badge-computed" style="font-size:0.75rem;">
                <?php echo e($snapshotCount); ?>/<?php echo e($activeCount); ?> pulled
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($correctedCount > 0): ?> · <?php echo e($correctedCount); ?> corrected <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </span>
        <?php else: ?>
    ...
    <div class="card-body">
        ...
        <?php elseif($snapshotCount < $activeCount): ?>
            <div class="alert alert-warning" style="margin-bottom:12px;">
                <strong>⚠ Partial pull:</strong> <?php echo e($snapshotCount); ?> of <?php echo e($activeCount); ?> employees have attendance data. Consider re-pulling.
            </div>
        <?php else: ?>
            <div class="alert" style="background:#F1FAF5; border-color:#A8D5B5; margin-bottom:12px;">
                ✅ Attendance pulled for all <?php echo e($snapshotCount); ?> employees.
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($correctedCount > 0): ?>
                    <strong><?php echo e($correctedCount); ?> record(s) manually corrected by HR.</strong>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                Review below, then compute.
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($snapshots->count() > 0): ?>
            <button type="button" class="btn btn-outline btn-sm" style="margin-bottom:12px;"
                    onclick="this.nextElementSibling.style.display = this.nextElementSibling.style.display === 'none' ? 'block' : 'none'">
                👁 Show / Hide Attendance Records (<?php echo e($snapshots->count()); ?>)
            </button>
            <div style="display:none; overflow-x:auto;">
                <table style="font-size:0.82rem; min-width:600px; width:100%;">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $snapshots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $snap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr style="<?php echo e($snap->is_corrected ? 'background:#FFF8E1;' : ''); ?>">
                                <td>
                                    <div class="fw-bold" style="font-size:0.83rem;">
                                        <?php echo e(optional($snap->employee)->last_name); ?>, <?php echo e(optional($snap->employee)->first_name); ?>

                                    </div>
                                    <div class="text-muted" style="font-size:0.72rem;"><?php echo e(optional($snap->employee)->employee_no); ?></div>
                                </td>
                                <td class="text-center"><?php echo e(number_format($snap->days_present, 1)); ?></td>
                                <td class="text-center <?php echo e($snap->lwop_days > 0 ? 'text-red fw-bold' : ''); ?>">
                                    <?php echo e(number_format($snap->lwop_days, 3)); ?>

                                </td>
                                <td class="text-center <?php echo e($snap->late_minutes > 0 ? 'text-red' : ''); ?>">
                                    <?php echo e($snap->late_minutes); ?>

                                </td>
                                <td class="text-center <?php echo e($snap->undertime_minutes > 0 ? 'text-red' : ''); ?>">
                                    <?php echo e($snap->undertime_minutes); ?>

                                </td>
                                <td class="text-center">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($snap->is_corrected): ?>
                                        <span class="badge badge-pending" title="<?php echo e($snap->correction_note); ?>">✏ HR Corrected</span>
                                    <?php else: ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canCompute): ?>
                                    <td class="text-center">
                                        <a href="<?php echo e(route('payroll.attendance.edit', [$payroll, $snap])); ?>"
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payroll->status === 'draft' && $employeeCount === 0): ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employeeCount > 0): ?>
<div class="card" style="overflow:visible;">
    <div class="card-header">
        <h3>Payroll Register — <?php echo e($periodLabel); ?> (<?php echo e($employeeCount); ?> Employees)</h3>
        ...
        <div class="table-wrap">
            <table id="payrollRegisterTable" class="virtual-scroll-table">
                <colgroup>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allowanceColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <thead class="virtual-scroll-thead">
                    <tr>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allowanceColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <th style="color:white;" class="text-right"><?php echo e($col->name); ?></th>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                ...
                <tfoot class="virtual-scroll-tfoot">
                    <tr class="tfoot-totals" style="background:var(--navy); color:white;">
                        ...
                        <td colspan="2" style="padding:12px 14px; color:rgba(255,255,255,0.7); font-size:0.82rem;">
                            TOTALS - <?php echo e($employeeCount); ?> employee<?php echo e($employeeCount !== 1 ? 's' : ''); ?>

                        </td>
                        <td class="text-right" style="color:white;">
                            ₱<?php echo e(number_format($payroll->entries->sum('basic_salary'), 2)); ?>

                        </td>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $allowanceColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <td class="text-right" style="color:white;">
                            <?php $colTotal = $allowanceTotals[$col->code] ?? 0; ?>
                            <?php echo e($colTotal > 0 ? '₱' . number_format($colTotal, 2) : ''); ?>

                        </td>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <td class="text-right" style="color:var(--gold); background:rgba(249,168,37,0.15);">
                            ₱<?php echo e(number_format($totalGross, 2)); ?>

                        </td>
                        <td class="text-right" style="color:white;">
                            ₱<?php echo e(number_format($payroll->entries->sum('tardiness') + $payroll->entries->sum('undertime'), 2)); ?>

                        </td>
                        <td class="text-right" style="color:white;">
                            ₱<?php echo e(number_format($payroll->entries->sum('lwop_deduction'), 2)); ?>

                        </td>
                        <td></td>
                        <td class="text-right" style="color:white;">
                            ₱<?php echo e(number_format($totalDeds, 2)); ?>
            ...
            ?>
            <script>
                window.virtualRowData = <?php echo json_encode($virtualRows, 15, 512) ?>;
                window.allowanceColumnCodes = <?php echo json_encode($allowanceColumns->pluck('code'), 15, 512) ?>;
                window.payrollStatus = <?php echo json_encode($payroll->status, 15, 512) ?>;
                window.payrollId = <?php echo json_encode($payroll->id, 15, 512) ?>;
                window.canRemoveEntry = <?php echo json_encode($canRemoveEntry, 15, 512) ?>;
                window.csrfToken = <?php echo json_encode(csrf_token(), 15, 512) ?>;
            </script>
        </div>
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isComputed): ?>
        <div class="card-body cert-footer" style="background:#FAFBFF; border-top:1px solid var(--border); padding:14px 20px;">
            <div class="d-flex gap-2 flex-wrap"
                ...
                <div>
                    ...
                    <?php echo e($payroll->creator->name ?? '—'); ?>

                    <span class="text-muted">· <?php echo e($payroll->created_at->format('M d, Y')); ?></span>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payroll->approved_by): ?>
                    <div>
                        <strong>Approved by:</strong>
                        <?php echo e(optional($payroll->approver)->name ?? '—'); ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payroll->approved_at): ?>
                            <span class="text-muted">· <?php echo e(\Carbon\Carbon::parse($payroll->approved_at)->format('M d, Y')); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($payroll->released_at): ?>
                    <div>
                        <strong>Released:</strong>
                        <span class="text-muted"><?php echo e(\Carbon\Carbon::parse($payroll->released_at)->format('M d, Y g:i A')); ?></span>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<div class="card" style="margin-top:24px;">
    <div class="card-header">
        ...
        <span class="text-muted" style="font-size:0.80rem;">
            <?php echo e($auditLogs->count()); ?> entr<?php echo e($auditLogs->count() === 1 ? 'y' : 'ies'); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $auditLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td style="white-space:nowrap;">
                                <?php echo e(\Carbon\Carbon::parse($log->performed_at)->format('M d, Y g:i A')); ?>
                            ...
                            <td class="text-muted"><?php echo e($log->ip_address ?? '—'); ?></td>
                        </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </tbody>
            </table>
        ...
        <div style="margin-bottom:20px;">
            ...
            <select id="payslipEmployee"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <option value="<?php echo e($entry->id); ?>"><?php echo e($entry->employee->full_name); ?></option>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </select>
        </div>
...
<script>
const snapshotCount = <?php echo e($snapshotCount ?? 0); ?>;
...
function confirmPullAndCompute() {
    const periodLabel = '<?php echo e($payroll->period_month_name); ?> <?php echo e($payroll->cutoff); ?>, <?php echo e($payroll->period_year); ?>';
...
async function executePullAndCompute(periodLabel) {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route("payroll.pullAndCompute", $payroll)); ?>', {
            method: 'POST',
            headers: {
...
function submitPayslip() {
    ...
    const base     = '<?php echo e(route("payroll.payslips.generate", $payroll)); ?>';
...
async function confirmNextAction() {
    ...
    const confirmMessage = "<?php echo e($nextAction['confirm'] ?? 'Are you sure?'); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Training_Ground\Visual Studio Code\DOLESYSTEM2\Dole_Payroll\Modules/Payroll\resources/views/payroll/show.blade.php ENDPATH**/ ?>