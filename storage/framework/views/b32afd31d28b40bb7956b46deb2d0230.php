...
<div class="app-shell">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <?php else: ?>
            <a href="<?php echo e(route('payroll.dashboard')); ?>"
                       class="nav-item <?php echo e(request()->routeIs('payroll.dashboard') ? 'active' : ''); ?>">
                    <span class="nav-icon">
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('role', 'payroll_officer|hrmo|accountant|chief_admin_officer|super_admin')): ?>
            ...
            <a href="<?php echo e(route('divisions.index')); ?>"
               class="nav-item <?php echo e(request()->routeIs('divisions.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white" style="display: block;">
            ...
            <a href="<?php echo e(route('payroll.index')); ?>"
               class="nav-item <?php echo e(request()->routeIs('payroll.index') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white" style="display: block;">
            ...
            <a href="<?php echo e(route('special-payroll.newly-hired.index')); ?>"
               class="nav-item nav-indented <?php echo e(request()->routeIs('special-payroll.newly-hired.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white" style="display: block;">
            ...
            <a href="<?php echo e(route('special-payroll.differential.index')); ?>"
               class="nav-item nav-indented <?php echo e(request()->routeIs('special-payroll.differential.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white" style="display: block;">
            ...
            <a href="<?php echo e(route('special-payroll.nosi-nosa.index')); ?>"
               class="nav-item nav-indented <?php echo e(request()->routeIs('special-payroll.nosi-nosa.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white" style="display: block;">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! (auth()->user()->hasAnyRole(['payroll_officer','hrmo','accountant','ard','cashier','chief_admin_officer','super_admin']))): ?>
            <div class="nav-section-label">Payroll</div>
            <a href="<?php echo e(route('my-payslip')); ?>"
               class="nav-item <?php echo e(request()->routeIs('my-payslip') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('deduction-types.index')); ?>"
               class="nav-item <?php echo e(request()->routeIs('deduction-types.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white" style="display: block;">
            ...
            <a href="<?php echo e(route('payroll.allowances.types.index')); ?>"
               class="nav-item <?php echo e(request()->routeIs('payroll.allowances.types.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white" style="display: block;">
            ...
            <a href="<?php echo e(route('reports.index')); ?>"
               class="nav-item <?php echo e(request()->routeIs('reports.index') || request()->routeIs('reports.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white" style="display: block;">
            ...
            <a href="<?php echo e(route('signatories.index')); ?>"
               class="nav-item <?php echo e(request()->routeIs('signatories.*') ? 'active' : ''); ?>">
                <span class="nav-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white" style="display: block;">
        ...
        <div class="sidebar-footer">
            <a href="<?php echo e(route('tev.dashboard')); ?>" class="btn-switch" title="Go to TEV">
                Go to TEV
            </a>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="topbar-user-pill">
                    <div class="user-info">
                        ...
                        <div class="user-role">
                            ...
                            ?>
                            <?php echo e($roleName ? str_replace('_', ' ', ucwords($roleName)) : 'Employee'); ?>
...
<?php /**PATH C:\Training_Ground\Visual Studio Code\DOLESYSTEM2\Dole_Payroll\resources\views/layouts/app.blade.php ENDPATH**/ ?>